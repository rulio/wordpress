...
(function() {
    ...
    Annotator = (function(_super) {
        ...
        Annotator.prototype.checkForEndSelection = function(event) {
            ...
            if (event && this.selectedRanges.length && this.hasPostPermission()) {
                return this.adder.css(Util.mousePosition(event, this.wrapper[0])).show();
            } else {
                return this.adder.hide();
            }
        };
        Annotator.prototype.hasPostPermission = function() {
            return this.plugins.Auth.haveValidToken();
        };
    ...
    Annotator.Plugin.Auth = (function(_super) {
        ...
        Auth.prototype.requestToken = function() {
            ...
            return $.ajax({
                url: this.options.tokenUrl+"?_wpnonce="+this.options.nonce,
                dataType: 'text',
                xhrFields: {
    ...
    Annotator.Plugin.Store = (function(_super) {
        ...
        Store.prototype.pluginInit = function() {
            ...
            if (this.annotator.plugins.Auth) {
                 // View all annotations with or without authentication.
